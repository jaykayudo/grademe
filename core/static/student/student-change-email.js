...
//         <input type="tel" pattern="\d*" id="currentCode" maxlength="6" class="form-input" placeholder="EX: 012345">
//         <span class="error-text"></span>
//         <span class="small-text">A 6 digit code has been sent to your new email.</span>
//     </div>
// `;
// const verifyNewCodeInput = `
//     <div class="form-group">
//         <label class="form-input-label">New Email Code</label>

//         <input type="tel" pattern="\d*" id="newCode" maxlength="6" class="form-input" placeholder="EX: 012345">
//         <span class="error-text"></span>
//         <span class="small-text">A 6 digit code has been sent to your new email.</span>
//     </div>
// `;
// const emailInputFormat = `
// <div class="form-group">
//     <label class="form-input-label">Current Email</label>
//     <input type="email" id="newEmail" class="form-input" placeholder="EX: emailaddress@domain.com">
//     <span class="error-text"></span>
// </div> 
// `;
let statusDigit = 1;
